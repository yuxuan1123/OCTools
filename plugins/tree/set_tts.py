"""
OCTools/ui/tabs/plugins/tree/set_tts.py
───────────────────────────────────────────────
...
class SetTts(OptionsDialogBase):
    ...
    def __init__(self, config: TtsConfig, parent=None):
        ...
        self.fit_size(640, 620, min_w=560, min_h=480)
        ...
        # ── 引擎与预设 ──
        card1, c1 = self.build_section_card("引擎与预设", body)
        ...
        # ── 参数区 ──
        card2, c2 = self.build_section_card("参数设置", body)
        self._stack = QStackedWidget(card2)
