"""
OCTools/plugins/merge/tab_merge.py
───────────────────────────────────────────────
...
from plugins.merge import (
    card_input, card_target, card_output, button_merge, card_log,
)
from plugins.merge import actions, target_ctl, engine_ctl, runner
from plugins.merge.registry import build_format_list
