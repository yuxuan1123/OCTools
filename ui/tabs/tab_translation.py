...
from ui.tabs.translation import (
    card_direction, card_screen, card_voice, card_source,
    card_result, card_log, button_translate,
)
from ui.tabs.translation import actions, runner, engine_ctl, app_controller
...
class TabTranslation(QWidget):
    ...
    def open_translator_options(self):
        ...
        from ui.options.set_translator import SetTranslator
    ...
    def open_stt_options(self, stt_config):
        """打开「语音识别参数」对话框"""
        from ui.options.set_stt import SetStt
